...
function(e) {
    ...
    P = {
        ...
        sendAuthCode: function(e) {
            ...
            s = function(a) {
                t--,
                t < 0 ? (n.removeClass(y).html("获取验证码"), t = e.seconds, clearInterval(i)) : n.addClass(y).html(t + "秒后重获"),
        ...
        sideFlexible: function(e) {
            ...
            t = a("#" + m),
            s = P.screen();
            "spread" === e ? (t.removeClass(g).addClass(b), s < 2 ? i.addClass(p) : i.removeClass(p), i.removeClass(x)) : (t.removeClass(b).addClass(g), s < 2 ? i.removeClass(x) : i.addClass(x), i.removeClass(p)),
        ...
        theme: function(e) {
            ...
            "styleSheet" in l ? (l.setAttribute("type", "text/css"), l.styleSheet.cssText = o) : l.innerHTML = o,
            l.id = s,
            d && r[0].removeChild(d),
            r[0].appendChild(l),
        ...
        tabsBodyChange: function(e, a) {
            a = a || {},
            P.tabsBody(e).addClass(u).siblings().removeClass(u),
            A.rollPage("auto", e),
        ...
        resize: function(e) {
            var a = layui.router(),
            i = a.path.join("-");
            o.off("resize", P.resizeFn[i]),
            e(),
            P.resizeFn[i] = e,
            o.on("resize", P.resizeFn[i])
        },
        resizeFn: {},
        runResize: function() {
            var e = layui.router(),
    ...
    A = P.events = {
        ...
        theme: function() {
            P.popupRight({
                ...
                success: function() {
                    s(this.id).render("system/theme.html")
                }
            })
        },
        note: function(e) {
    ...
    r.on("click", "*[layadmin-event]",
    function() {
        var e = a(this),
        i = e.attr("layadmin-event");
        A[i] && A[i].call(this, e)
    }),
    r.on("mouseenter", "*[lay-tips]",
    function() {
        var e = a(this);
